...
export default class MenuScene {
    ...
    update(dt) {
        let opacityValue = this.menuActiveOpacity + dt / this.opacityDyrection

        if (opacityValue > 1 || opacityValue <0) this.opacityDyrection *= -1
        
        this.menuActiveOpacity += dt / this.opacityDyrection
        ...
        if (this.game.checkKeyPress('ArrowDown')) {
            ...
            this.menuIndex--
            if (this.menuIndex < 0) this.menuIndex.length -1;
        }
